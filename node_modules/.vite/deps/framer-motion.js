...
var NativeAnimation = class extends WithPromise {
  constructor(options) {
    ...
    if (!options)
      return;
    const { element, name, keyframes: keyframes2, pseudoElement, allowFlatten = false, finalKeyframe } = options;
...
var AsyncMotionValueAnimation = class extends WithPromise {
  ...
  onKeyframesResolved(keyframes2, finalKeyframe, options, sync2) {
    ...
    const { name, type, velocity, delay: delay2, isHandoff, onUpdate, onComplete } = options;
